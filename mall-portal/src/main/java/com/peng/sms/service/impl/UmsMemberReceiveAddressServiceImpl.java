...
import com.peng.sms.mapper.UmsMemberReceiveAddressMapper;
import com.peng.sms.model.UmsMember;
import com.peng.sms.model.UmsMemberReceiveAddress;
import com.peng.sms.model.UmsMemberReceiveAddressExample;
...
public class UmsMemberReceiveAddressServiceImpl implements UmsMemberReceiveAddressService {
    ...
    public int update(Long id, UmsMemberReceiveAddress address) {
        ...
        if (address.getDefaultStatus() == 1) {
            // If setting as default, first unset the original default address
